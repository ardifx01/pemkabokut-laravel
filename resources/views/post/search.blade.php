    ...
    <section id="search-results-section" class="py-4">
        <div class="container" style="padding-top: 100px;">
            ...
            @else
                ...
                {{-- Grid for search result posts and documents --}}
                <div class="row">
                            ...
                            <div class="card border-0 shadow-sm">
                                <div class="card-body">
                                    @if ($result instanceof App\Models\Post)
                                        ...
                                        @if ($firstImage)
                                            ...
                                            @else
                                                <img src="{{ asset('storage/' . $firstImage) }}" class="img-fluid mb-3"
                                                    alt="Gambar Post" style="width: 100%; height: 200px; object-fit: cover; border-radius: 5px;">
                                            @endif
                                        @else
                                            <img src="{{ asset('images/placeholder.png') }}" class="img-fluid mb-3" alt="Placeholder Image"
                                                style="width: 100%; height: 200px; object-fit: cover; border-radius: 5px;">
                                        @endif
                                        ...
                                        <p class="card-text">{{ Str::limit(strip_tags($result->description), 100, '...') }}</p>
                                        <a href="/post/show/{{ $result->id }}" class="btn btn-primary">Selengkapnya</a>

                                    @elseif ($result instanceof App\Models\Document)
                                        {{-- Ini adalah hasil Document --}}
                                        {{-- Gunakan image lokal seperti pada search document sebelumnya --}}
                                        <img src="{{ asset('/icons/dokumen.jpg') }}" class="img-fluid mb-3" alt="Document Image"
                                            style="width: 100%; height: 200px; object-fit: cover; border-radius: 5px;">
                                        ...
                                        {{-- Menampilkan file terkait document --}}
                                        <p class="card-text">

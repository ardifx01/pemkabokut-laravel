...
@section('content')
            ...
            <form action="{{ route('file.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 d-flex align-items-center">
                    <div class="me-2" style="flex: 1;">
                        ...
                        <input type="file" class="form-control" id="file_path" name="file_path[]" multiple required style="width: 725px;">
                    </div>

                    <!-- Button to trigger file input -->
                    <button type="button" id="add-file-btn" class="btn btn-secondary mb-3" style="margin-top: 45px">Add File</button>
                </div>
    ...
    <style>
        .select2-container .select2-selection--single {
            height: 37px; /* Sesuaikan tinggi sesuai kebutuhan */
            padding: 3px; /* Sesuaikan padding untuk konten di dalamnya */
        }

        .select2-container--default .select2-selection--single .select2-selection__rendered {
            line-height: 30px; /* Sesuaikan line-height agar teks berada di tengah */
        }
        
        .select2-container--default .select2-selection--single .select2-selection__arrow {
            height: 40px; /* Sesuaikan tinggi panah dropdown */
        }
    </style>
